...
public class FirstStepDef {
    ...
    /** Cucumber uses regex to map feature file steps with glue code step definitions **/
    ...
    public void userTestGmailComWithPasswordSomePssIsRegistered() {
    }

    @When("^User test@gmail\\.com with password somePss logs in$")
    public void userTestGmailComWithPasswordSomePssLogsIn() {
    }

    @Then("^User test@gmail\\.com should be navigated to HomePage$")
    public void userTestGmailComShouldBeNavigatedToHomePage() {
    }
